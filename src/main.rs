...
",
                ...
                String::from(
                    "He walked out of that ship showcase determined thinking that even if he wouldn't win on this, he still had the option of virality at hand",
                ),
                String::from(
                ...
                String::from(
                    "He looked for anything... desperate for what could allow him to finish all his projects in time. He searched and searched and ran his eyes dry until finally he discovered a loophole. The projects didn't technically need to be finished, but rather they would need to be in a functional state.",
                ),
                String::from(
                    "The young error code dashed to submit his projects after trying to wrap up what functional state he believed they were in. That island was finally in reach.",
                ),
                String::from(
                    "After submitting everything and realizing it was all in order, he stared upwards at the 95%. \"95? Why am I behind by just 5%?\". He looked around and around until he saw his project orpheus. He realized he only had 12 out of the 15 hours required for orpheus.",
                ),
                String::from(
                    "Desperate for just three more hours added to his count, he looked for any features to add to the project.",
                ),
                String::from("He settled on writing this command..."),
                String::from("Based on a true story. Shipwrecked admins pls accept this."),
                String::from("PART 2:"),
                String::from(
                    "The confident ErrorCode0 stepped up to the mighty platform upon which the shipwrecked organizers rested upon.",
                ),
                String::from(
                    "He tapped his foot on the ground, in that same rhythmic fashion as one would knock on a door with.",
                ),
                String::from(
                    "The towering shipwrecked organizer awoke from his slumber: \"WHO DARES AWAKE ME FROM MY SLUMBER\"",
                ),
                String::from(
                    "The young programmer got onto a knee and said \"My lord, please accept my humble request of a rounding of my hours on my project of name Orphy. I have exceeded the count of hours within all my other projects by a surplus of nearing 20 per! Please my lord",
                ),
                String::from(
                    "The shipwrecked organizer laughed a hearty and evil chuckle. \"You stupid mortal. I will not do that for that is FRAUD. You don't want to be banned from this event for fraud would you?\" He picked up the young programmer.",
                ),
                String::from(
                    "\"I don't want to see you here until 15 hours no less has been reached by your puny project. Have we come to an understanding, or do more... serious measures need to be taken into account\"",
                ),
                String::from(
                    "The bumbling giant dropped the young programmer down into sea of piracy. He came to realize that he would need more than a humble request to persuade the organizer.",
                ),
                String::from(
                    "The humble programmer peered into his hackatime stats to no avail. He had only accumulated 14 hours and 4 minutes of the required time he would need. He wouldn't make it onto this hackathon unless a miracle took place.",
                ),
                String::from("Is this the end for our young ErrorCode0's journey?"),
                String::from(
                    "He worked tirelessly to stretch his time to the 15 hour mark. Useless feature here, unecessary story there, but it was tireless work. This last hour felt more demanding than all that had come before it and it certainly required much of him.",
                ),
                String::from(
                    "Slowly the time ticked up. Hackatime began reporting his time slowly increasing as he typed on and on yapping and yapping.",
                ),
                String::from(
                    "His mind slowly began to blank. What else could he write about? There was literally nothing else he could say. He had yapped away for nearly a century at this point and yet the 1 final hour still had not been reached.",
                ),
                String::from(
                    "Perhaps if the requirements were a bit less stringent he would have a choice.",
                ),
                String::from("He isn't as lucky as he would hope unfortunately."),
                String::from("PART 3:"),
                String::from(
                    "One morning, he woke up to a ping on slack. The hacker news tracker finally updated: The project blew up.",
                ),
                String::from(
                    "He opened the github to see nearly 50+ stars compared to last night.",
                ),
                String::from("\"Wow... that's actually pretty crazy. How did that happen?\""),
                String::from(
                    "The hacker news mods realized this was a golden piece of content that slipped through the cracks. They gloriously blessed the article with a second chance to hit the front page.",
                ),
                String::from(
                    "It was a little late for it to go viral but nevertheless it was still helpful for the project.",
                ),
                String::from(
                    "He walked towards the platform for the final time. Hours in hand, virality on his chest, and a tough demeanor on the outside.",
                ),
                String::from(
                    "\"You again??\" the shipwrecked organizer grunted. \"Haven't you troubled me enough?\"",
                ),
                String::from(
                    "\"I finally fulfilled the requirements. Let me through onto the island\"",
                ),
                String::from("\"I suppose you can make it aboard\""),
                String::from("\"THE END\""),
                String::from(
                    "shipwrecked organizer is not anyone in particular but it's just an embodiment of the different setbacks I had wwhile trying to qualify for this event put into the body of a giant.",
                ),
                String::from(
                    "pls don't mark my hours for fraud ok since writing this story == coding time",
                ),
                String::from("ty for reading this story."),
                String::from("im still typing so I can hit the five minute mark."),
                String::from(
                    "these last lines are useless but I will hit 15 hours no matter what.",
                ),
                ...
                String::from(
                    "i would recommend just Control-C-ing atp cus theres no use in reading the rest of this",
                ),
                String::from("ok bye"),
                String::from("alright fine you're still here."),
                String::from(
                    "you should look at my other stuff on my website -> errorcodezero.dev",
                ),
                String::from("my github is @errorcodezero"),
                String::from("if you don't alr know, this is a terminal client for hackclub mail."),
                String::from(
                    "Hackclub mail is this system to track packages and whatnot that hc is sending u",
                ),
                String::from(
                    "if you don't know what hackclub is well... hackclub.com will probably get you sorted out.",
                ),
                ...
                String::from(
                    "this command never would have existed if the minimum requirement for a project wasn't 15 hours with no option to overflow.",
                ),
